...
const Show = () => {
 ...
 />
        ...
        <div className="column nature">
          <div className="content">
          <img src="https://images.pexels.com/photos/1586996/pexels-photo-1586996.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Mountains"         style={{ width: '100%', height: '300px', objectFit: 'cover' }}
 />
            <h4>Vishal</h4>
...
/>
        ...
        <div className="column people">
          <div className="content">
            <img src="https://images.pexels.com/photos/1181690/pexels-photo-1181690.jpeg?auto=compress&cs=tinysrgb&w=600" alt="yamms"         style={{ width: '100%', height: '300px', objectFit: 'cover' }}
 />
            <h4>chandana</h4>
